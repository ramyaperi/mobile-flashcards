...
class DeckDetail extends Component {
  ...
  componentDidMount(){
    Animated.timing(this.state.opacity,   {toValue: 1,  duration: 10000  }).start();
  ...
  render() {
    ...
    return(
      <Animated.View style={{flex: 1 , opacity}}>
        ...
        <Text style={styles.heading}>{this.props.deckList[this.props.navigation.state.params.deckId].questions.length} cards</Text>
        { this.props.deckList[this.props.navigation.state.params.deckId].questions.length > 0 &&
          <TouchableOpacity style={styles.button}
            onPress={() => this.props.navigation.navigate('StartQuizScreen',

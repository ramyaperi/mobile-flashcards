...
export function getDecks () {
  return (dispatch) => {AsyncStorage.getItem(FLASH_CARD_STORAGE_KEY).then(JSON.parse).then((decks)=> {
...
export function removeDeck (deckid) {
  console.log(deckid);
  return (dispatch) => {AsyncStorage.getItem(FLASH_CARD_STORAGE_KEY).then(JSON.parse).then((data) => {
...
export function addCardToDeck (deckid,cardData) {
  ...
  return (dispatch) => { AsyncStorage.getItem(FLASH_CARD_STORAGE_KEY).then(JSON.parse).then((result) =>  {
